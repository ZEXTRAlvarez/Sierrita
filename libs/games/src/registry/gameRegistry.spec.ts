...
describe('ALL_GAMES', () => {
  it('registers exactly 12 games across the 3 worlds', () => {
    expect(ALL_GAMES).toHaveLength(12);
  });
...
describe('getWorldGames', () => {
  ...
  it('returns the 4 ocean games', () => {
    expect(getWorldGames('ocean')).toHaveLength(4);
  });
