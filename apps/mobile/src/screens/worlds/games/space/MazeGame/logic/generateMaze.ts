...
export const OPPOSITE: Record<Dir, Dir> = { top: 'bottom', bottom: 'top', left: 'right', right: 'left' };
export const MOVES: Record<Dir, [number, number]> = { top: [-1, 0], bottom: [1, 0], left: [0, -1], right: [0, 1] };
