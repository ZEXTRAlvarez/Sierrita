...
export function useClassifyGameState({
  categories, attribute, itemCount, onRoundComplete, onGameFinish, roundCount,
  ...
  return { round, bins, pending, selected, result, roundsDone, bounceAnim, handleItemPress, handleBinPress };
}
