...
export const WORLDS: WorldDef[] = [
  {
    id: 'jungle', iconName: 'selva', name: 'Selva Mágica', subject: 'Escritura',
  ...
  {
    id: 'ocean', iconName: 'oceano', name: 'Océano Profundo', subject: 'Matemáticas',
  ...
  {
    id: 'space', iconName: 'cohete', name: 'Espacio Estelar', subject: 'Lógica',
