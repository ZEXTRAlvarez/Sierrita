...
export default function PetScreen() {
  ...
  return (
    <ImageBackground source={require('../../../assets/images/Fondo-detalle.png')} style={styles.bg} resizeMode="cover">
      <LinearGradient
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.titleRow}>
          ...
          <TouchableOpacity onPress={() => setShowRename(true)} hitSlop={10} style={styles.editNameBtn} activeOpacity={0.7}>
            <Text style={styles.editNameIcon}>✏️</Text>
          </TouchableOpacity>
        </View>

        <PetStageDisplay petType={petState.petType} mood={mood} moodCfg={moodCfg} bounceY={bounceY} actionScale={actionScale} />
        ...
        <TouchableOpacity style={styles.detailBtn} onPress={() => navigation.navigate('PetDetail')} activeOpacity={0.85}>
